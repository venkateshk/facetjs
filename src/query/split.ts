...
import FacetSegmentFilterModule = require("./segmentFilter");
import FacetSegmentFilter = FacetSegmentFilterModule.FacetSegmentFilter;
import FacetSegmentFilterJS = FacetSegmentFilterModule.FacetSegmentFilterJS;

import FilterModule = require("./filter");
import FacetFilter = FilterModule.FacetFilter;
import FiltersByDataset = FilterModule.FiltersByDataset;
import IsFilter = FilterModule.IsFilter;
import WithinFilter = FilterModule.WithinFilter;
import AndFilter = FilterModule.AndFilter;

import FacetOptionsModule = require("./options");
import FacetOptions = FacetOptionsModule.FacetOptions;
import FacetOptionsJS = FacetOptionsModule.FacetOptionsJS;
