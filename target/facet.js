...
(function() {
  var FacetJob, Segment, arraySubclass, boxPosition, divideLength, facet, flatten, getProp, getScale, isValidStage, stripeTile, wrapLiteral,
    __slice = [].slice;
  ...
  FacetJob = (function() {
    ...
    FacetJob.prototype.render = function() {
      ...
      this.driver(this.getQuery(), function(err, res) {
        var cmd, hops, i, layout, name, newStage, param, parentSegment, plot, psudoStage, psudoStages, scale, segment, segmentGroup, segmentGroups, sourceSegment, stage, transform, unifiedSegments, _i, _j, _k, _l, _len, _len1, _len10, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _s;
        if (err) {
