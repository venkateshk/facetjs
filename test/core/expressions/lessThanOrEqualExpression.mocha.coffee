...
describe 'LessThanOrEqualExpression', ->
  ...
  describe 'with left-handed reference', ->
    beforeEach ->
      this.expression = { op: 'lessThanOrEqual', lhs: { op: 'ref', name: 'test' }, rhs: { op: 'literal', value: 5 } }

    tests.complexityIs(3)
    tests.simplifiedExpressionIs({ op: 'lessThanOrEqual', lhs: { op: 'ref', name: 'test' }, rhs: { op: 'literal', value: 5 } })
  ...
  describe 'with right-handed reference', ->
    ...
    tests.complexityIs(3)
    tests.simplifiedExpressionIs({ op: 'lessThanOrEqual', lhs: { op: 'literal', value: 5 }, rhs: { op: 'ref', name: 'test' } })
