...
describe "FacetFilter", ->
  ...
  describe "equals", ->
    it "works for all filters", ->
      ...
      expect(filter1.equals(filter2)).to.equal(true)
      expect(filter1.equals(filter3)).to.equal(false)
  ...
  describe "FacetFilter.filterDiff", ->
    it "computes a subset with IN filters", ->
      ...
      expect(diff[0].toJS()).to.deep.equal({
        type: 'is'
        attribute: 'state'
        value: 'California'
      })
